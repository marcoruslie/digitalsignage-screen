export default () => {
	...
	const changeJsonFile = async (resourceDir: string, fileName: string, json: any) => {
		try {
	...
	return { uploadFile, getFileList, getAllPlaylist, getReminder, saveFile, changeJsonFile }
}
