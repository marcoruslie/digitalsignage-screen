	...
	<div class="bg-gradient-to-tl from-Primary to-OnPrimaryContainer max-h-[90vh] h-[90vh] overflow-hidden">
		<div class="flex justify-center items-center w-full">
			<div class="flex flex-col h-[90vh] w-1/3 overflow-hidden shadow-lg">
				...
				<!-- Reminder -->
				<div
					class="h-1/2 bg-gradient-to-br from-OnPrimaryContainer to-Primary flex flex-col items-center bg-opacity-60 space-y-2 p-2">
					<div class="sm:text-3xl lg:text-5xl text-white p-1 h-1/5">Reminder !!!</div>
					<div
						v-for="remind in reminder"
						class="rounded text-OnPrimaryContainer w-full py-2 px-1 flex justify-between"
						:class="{
						...
						<div class="w-[70%] text-xl font-bold">{{ remind.Judul }}</div>
						<div class="flex justify-center items-center">
							{{ getFormattedTimeDifference(remind.Deadline) }}
						</div>
					</div>
				</div>
			</div>
